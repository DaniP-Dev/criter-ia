        ...
        <div className="my-24 grid grid-cols-1 gap-y-10 gap-x-8 sm:grid-cols-2 lg:grid-cols-12 xl:gap-x-8">
          ...
          <div className="col-span-12 sm:col-span-2 lg:col-span-4 flex flex-col items-center sm:items-start">
            <Image
              ...
              width={192}
              height={60}
              className="pb-8 w-32 sm:w-40 lg:w-48"
              priority
            />
            <div className="flex gap-4 justify-center sm:justify-start">
              <Link
                href="https://www.facebook.com/profile.php?id=61578752468834"
              ...
              <Link
                href="https://x.com/Somoscriteria"
              ...
              <Link
                href="https://www.instagram.com/somoscriteria/"
                className="footer-icons"
                target="_blank"
                rel="noopener noreferrer"
              >
          ...
          {products.map((product) => (
            <div
              key={product.id}
              className="group relative col-span-6 sm:col-span-1 md:col-span-4 lg:col-span-2 flex justify-center sm:justify-start"
            >
              <ul>
                {product.link.map((link: string, index: number) => (
                  <li key={index} className="mb-3 sm:mb-5">
                    <Link
                      href="/"
                      className="text-white text-sm font-normal mb-6 space-links hover:underline"
                    >
                      {link}
                    </Link>
                  </li>
          ...
          <div className="col-span-12 sm:col-span-2 lg:col-span-4 flex flex-col gap-6 items-center sm:items-start">
            <div className="flex gap-2 items-center">
              <Image
                ...
                height={24}
              />
              <h5 className="text-base font-normal text-offwhite text-center sm:text-left">
                {t("address")}
              </h5>
            </div>
            <div className="flex gap-2 items-center">
